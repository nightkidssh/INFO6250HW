 ...
 * @author kym-1992
 */
public class Part4Javascript extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet Part4Javascript</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet Part4Javascript at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
