...
//    }
    ...
    void sendPage6(HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<BODY>");
        out.println("<CENTER><H2>Question 6</H2>");
        out.println("Which life-cycle method is clalled once in servlet life?<BR><BR>");
        out.println("<FORM METHOD=POST>");
        ...
        out.println("<INPUT TYPE=HIDDEN NAME=question3 VALUE=\"" + question3 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question4 VALUE=\"" + question4 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question5 VALUE=\"" + question5 + "\"></TD>");
        out.println("<TABLE>");
        out.println("<TR>");
        out.println("<TD>1.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question6' VALUE='class loading' checked>class loading</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>2.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question6' VALUE='init'>init()</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>3.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question6' VALUE='service'>service()</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>4.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question6' VALUE='destroy'>destroy()</TD>");
        out.println("</TR>");     
    ...
    void sendPage7(HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<BODY>");
        out.println("<CENTER><H2>Question 7</H2>");
        out.println("Which method does not exists in HttpServlet Class?<BR><BR>");
        out.println("<FORM METHOD=POST>");
        ...
        out.println("<INPUT TYPE=HIDDEN NAME=question4 VALUE=\"" + question4 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question5 VALUE=\"" + question5 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question6 VALUE=\"" + question6 + "\"></TD>");
        out.println("<TABLE>");
        out.println("<TR>");
        out.println("<TD>1.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question7' VALUE='service' checked>service</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>2.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question7' VALUE='init'>init</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>3.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question7' VALUE='doGet'>doGet</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>4.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question7' VALUE='doPost'>doPost</TD>");
        out.println("</TR>");     
    ...
    void sendPage8(HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<BODY>");
        out.println("<CENTER><H2>Question 8</H2>");
        out.println("Which statements is not true about ServletConfig?<BR><BR>");
        out.println("<FORM METHOD=POST>");
        ...
        out.println("<INPUT TYPE=HIDDEN NAME=question5 VALUE=\"" + question5 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question6 VALUE=\"" + question6 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question7 VALUE=\"" + question7 + "\"></TD>");
        out.println("<TABLE>");
        out.println("<TR>");
        out.println("<TD>1.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question8' VALUE='There is one servlet config per one application' checked>There is one servlet config per one application</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>2.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question8' VALUE='We can access ServletContext through it'>We can access ServletContext through it</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>3.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question8' VALUE='provide deploy-time information to server'>provide deploy-time information to server</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>4.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question8' VALUE='There is one servlet config per one servlet'>There is one servlet config per one servlet</TD>");
        out.println("</TR>");     
    ...
    void sendPage9(HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<BODY>");
        out.println("<CENTER><H2>Question 9</H2>");
        out.println("Which interface contain servlet life-cycle methods?<BR><BR>");
        out.println("<FORM METHOD=POST>");
        ...
        out.println("<INPUT TYPE=HIDDEN NAME=question6 VALUE=\"" + question6 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question7 VALUE=\"" + question7 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question8 VALUE=\"" + question8 + "\"></TD>");
        out.println("<TABLE>");
        out.println("<TR>");
        out.println("<TD>1.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question9' VALUE='HttpServlet' checked>HttpServlet</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>2.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question9' VALUE='GenericServlet'>GenericServlet</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>3.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question9' VALUE='Service'>Service</TD>");
        out.println("</TR>");
        out.println("<TR>");
        out.println("<TD>4.&nbsp;</TD>");
        out.println("<TD><INPUT TYPE='RADIO' NAME='question9' VALUE='Servlet'>Servlet</TD>");
        out.println("</TR>");     
    ...
    void sendPage10(HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<BODY>");
        out.println("<CENTER><H2>Question 10</H2>");
        out.println("Which method is called when client request come?<BR><BR>");
        out.println("<FORM METHOD=POST>");
        ...
        out.println("<INPUT TYPE=HIDDEN NAME=question7 VALUE=\"" + question7 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question8 VALUE=\"" + question8 + "\"></TD>");
        out.println("<INPUT TYPE=HIDDEN NAME=question9 VALUE=\"" + question9 + "\"></TD>");
        out.println("<TABLE>");
        out.println("<TR>");
        out.println("<TD>1.&nbsp;</TD>");
